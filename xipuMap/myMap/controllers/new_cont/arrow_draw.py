...
def arrow_left(draw, width, height, vertical_length=40, horizontal_length=40, arrow_head_length=20, arrow_head_width=12, handle_width=4, smooth_gap=3):
...
def arrow_right(draw, width, height, vertical_length=40, horizontal_length=40, arrow_head_length=20, arrow_head_width=12, handle_width=4, smooth_gap=3):
...
def arrow_up(draw, width, height, arrow_length=53, arrow_head_length=20, arrow_head_width=16, handle_width=5, handle_gap=3):    
    offset_x = -80
    offset_y = -48
