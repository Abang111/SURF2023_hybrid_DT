...
def navigation_info_left(draw, width, height, text, font_path="arial.ttf", font_size=20):
    # 加载字体
    ...
    offset_y = -80   # 根据文本高度和箭头的位置调整此偏移量
...
def navigation_info_up(draw, width, height, text, font_path="arial.ttf", font_size=18):
    # 加载字体
    font = ImageFont.truetype(font_path, font_size)
...
def navigation_info_right(draw, width, height, text, font_path="arial.ttf", font_size=18):
    # 加载字体
    font = ImageFont.truetype(font_path, font_size)
